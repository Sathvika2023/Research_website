...
const ElectronicsInstrumentationCenter = () => {
  const [currentImage, setCurrentImage] = useState(0);
  const centerData = researchCenters.find(center => center.slug === 'electronics-and-instrumentation-engineering');
  ...
  return (
    <div className="flex flex-col lg:flex-row min-h-screen p-8">
      <div className="lg:w-2/3 pr-8">
        <h1 className="text-4xl font-bold mb-8">Electronics and Instrumentation Engineering Research Center</h1>
          ...
          <div className="flex gap-8">
            <div className="w-2/3">
              <p className="text-lg text-gray-700 mb-4">
                Our Electronics and Instrumentation Engineering Research Center focuses on research in control systems, instrumentation, and signal processing.
              </p>
            </div>
            <div className="w-1/3">
              <table className="w-full border-collapse">
                ...
                <tbody>
                  <tr>
                    ...
                    <td className="p-2 border">2016</td>
                  </tr>
                  <tr>
...
export default ElectronicsInstrumentationCenter;
