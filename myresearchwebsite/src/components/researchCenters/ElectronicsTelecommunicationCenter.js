...
const ElectronicsTelecommunicationCenter = () => {
  const [currentImage, setCurrentImage] = useState(0);
  const centerData = researchCenters.find(center => center.slug === 'electronics-and-telecommunication-engineering');
  ...
  return (
    <div className="flex flex-col lg:flex-row min-h-screen p-8">
      <div className="lg:w-2/3 pr-8">
        <h1 className="text-4xl font-bold mb-8">Electronics and Telecommunication Engineering Research Center</h1>
          ...
          <div className="flex gap-8">
            <div className="w-2/3">
              <p className="text-lg text-gray-700 mb-4">
                Our Electronics and Telecommunication Engineering Research Center focuses on research in wireless communication, signal processing, and network technologies.
              </p>
            </div>
            <div className="w-1/3">
        ...
        <div className="lg:w-1/3 relative">
          ...
          >
            <img 
              ...
              alt="Electronics and Telecommunication Engineering" 
...
export default ElectronicsTelecommunicationCenter;
