...
const MedicalElectronicsCenter = () => {
  const [currentImage, setCurrentImage] = useState(0);
  const centerData = researchCenters.find(center => center.slug === 'medical-electronics');
  ...
  return (
    <div className="flex flex极col lg:flex-row min-h-screen p-8">
      <div className="lg:w-2/3 pr-8">
        <h1 className="text-4xl font-bold mb-8">Medical Electronics Research Center</h1>
          ...
          <div className="flex gap-8">
            <div className="w-2/3">
              <p className="text-lg text-gray-700 mb-4">
                Our Medical Electronics Research Center focuses on research in biomedical instrumentation, medical imaging, and healthcare technologies.
              </p>
            </div>
            <div className="w-1/3">
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-semibold mb极4">Research Areas</h2>
...
export default MedicalElectronicsCenter;
