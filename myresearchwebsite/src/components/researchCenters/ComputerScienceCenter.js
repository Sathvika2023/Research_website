...
const ComputerScienceCenter = () => {
  const [currentImage, setCurrentImage] = useState(0);
  const centerData = researchCenters.find(center => center.slug === 'computer-science-and-engineering');
...
export default ComputerScienceCenter;
