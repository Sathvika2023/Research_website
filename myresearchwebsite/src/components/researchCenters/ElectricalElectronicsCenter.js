...
const ElectricalElectronicsCenter = () => {
  const [currentImage, setCurrentImage] = useState(0);
  const centerData = researchCenters.find(center => center.slug === 'electrical-and-electronics-engineering');
  ...
  return (
    <div className="flex flex-col lg:flex-row min-h-screen p-8">
      ...
      <div className="lg:w-2/3 pr-8">
        <h1 className="text-4xl font-bold mb-8">Electrical and Electronics Engineering Research Center</h1>
          ...
          <div className="flex gap-8">
            <div className="w-2/3">
              <p className="text-lg text-gray-700 mb-4">
                Our Electrical and Electronics Engineering Research Center focuses on advancements in power systems, automation, and electronic circuits. We work on innovative solutions for energy efficiency and smart technologies.
              </p>
            </div>
            <div className="w-1/3">
...
export default ElectricalElectronicsCenter;
