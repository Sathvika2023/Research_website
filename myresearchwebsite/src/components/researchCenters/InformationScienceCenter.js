...
const InformationScienceCenter = () => {
  const [currentImage, setCurrentImage] = useState(0);
  const centerData = researchCenters.find(center => center.slug === 'information-science-and-engineering');
  ...
  return (
    <div className="flex flex-col lg:flex-row min-h-screen p-8">
      <div className="lg:w-2/3 pr-8">
        <h1 className="text-4xl font-bold mb-8">Information Science and Engineering Research Center</h1>
          ...
          <div className="flex gap-8">
            <div className="w-2/3">
              <p className="text-lg text-gray-700 mb-4">
                Our Information Science and Engineering Research Center focuses on research in data science, cybersecurity, and intelligent systems.
              </p>
            </div>
            <div className="w-1/3">
        ...
        <div className="lg:w-1/3 relative">
          ...
          >
            <img 
              ...
              alt="Information Science and Engineering" 
...
export default InformationScienceCenter;
